...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simulácia prihlásenia - v produkčnom prostredí by tu bol API call
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Presmerovanie na dashboard po úspešnom prihlásení
      router.push('/dashboard');
    } catch (err) {
      setError('Nesprávne prihlasovacie údaje. Skúste to znova.');
    } finally {
      setLoading(false);
    }
  };

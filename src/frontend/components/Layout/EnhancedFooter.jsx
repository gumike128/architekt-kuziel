...
// Enhanced footer component with animations and improved UI
        ...
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0">
            <p className="text-center md:text-right text-base text-gray-400">
              &copy; {currentYear} Architekt kúziel. Všetky práva vyhradené.
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 border-t border-gray-200 pt-4">
          ...
          <div className="mt-4 text-center md:text-left">
            <p className="text-sm text-gray-500">
              Architekt kúziel je inteligentný, automatizovaný ekosystém pre prácu s informáciami a obsahom.
            </p>
          </div>
        </div>
      </div>
